...
- `quant raw-response` requests `format=csv` and prints the server's `text/csv` content, with the CLI's usual trailing newline (also for empty CSV). Other V1 responses continue to use JSON.
